...
```scala
libraryDependencies += "io.monix" %% "newtypes-core" % "1.0.0"
```
...
libraryDependencies += "io.monix" %% "newtypes-circe-v0-14" % "1.0.0"
```
...
libraryDependencies += "io.monix" %% "newtypes-pureconfig-v0-17" % "1.0.0"
```

NOTE: the [version scheme](https://www.scala-lang.org/blog/2021/02/16/preventing-version-conflicts-with-versionscheme.html) is set to `semver-spec`.
